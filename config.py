...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002204573607"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>hello guys first u have to join channel for watching sex video
नमस्कार दोस्तों सबसे पहले आपको सेक्स वीडियो देखने के लिए चैनल से जुड़ना होगा")
